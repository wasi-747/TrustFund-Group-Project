    ...
    <div className="pt-24 px-6 pb-12">
      ...
      <div className="max-w-6xl mx-auto mb-10 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <input
          ...
          className="p-3 w-full md:w-80 rounded-full bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 backdrop-blur-sm transition"
          value={searchTerm}
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {filteredCampaigns.map((camp) => (
            ...
            <div
              key={camp._id}
              className="rounded-2xl overflow-hidden bg-white/10 border border-white/10 backdrop-blur-md shadow-xl hover:-translate-y-2 transition-all duration-300"
            >
              ...
              <div className="p-5">
                ...
                <div className="w-full bg-gray-700/50 rounded-full h-2 mb-3">
                  <div
                    className="bg-gradient-to-r from-blue-400 to-purple-500 h-2 rounded-full shadow-[0_0_10px_rgba(59,130,246,0.6)]"
                    style={{
                      width: `${Math.min(
                ...
                <button className="w-full py-2 rounded-lg font-bold text-sm bg-white/10 hover:bg-white/20 border border-white/20 text-white transition">
                  View Details (W3)
                </button>
              </div>
            </div>
