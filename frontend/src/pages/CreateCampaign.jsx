...
const CreateCampaign = () => { 
  ...
  return ( 
    <div className="min-h-screen pt-32 pb-10 flex justify-center items-center px
4"> 
...
file:bg-blue-600 file:text-white hover:file:bg-blue-500" 
          ...
          <button className="w-full py-3.5 rounded-xl font-bold text-white bg
gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 
